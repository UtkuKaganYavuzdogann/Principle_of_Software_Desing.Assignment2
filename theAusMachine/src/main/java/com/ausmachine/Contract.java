...
public class Contract extends Customer{
    private final String seller ="The Automata System";
    private String type_of_vehicle = null;
    private String model = null;
    private String colour = null;
    private int bike_gear_amount = 0;
    private double price = 0;
    private  String payment_method= null;


    public Contract(String firstName, String lastName, String phone,String id, String type_of_vehicle, String model, String colour, int bike_gear_amount, double price, String payment_method) {
        super(firstName,lastName,phone,id);
        this.type_of_vehicle = type_of_vehicle;
        this.model = model;
        this.colour = colour;
        this.bike_gear_amount = bike_gear_amount;
        this.price = price;
    ...
    public void getContract(){
        System.out.println("***********************CONTRACT FOR SELLING A BIKE*********************** ");
        ...
        System.out.println("The Buyer will pay the Seller the purchase price in full by cash," +
                " credit card, or by Exchange with another car if agreed upon by both parties.");
        ...
        System.out.println("On the date of sale, the Seller promises to provide the Buyer with the vehicle title, registration,\n" +
                "odometer reading (or odometer disclosure statement where applicable), and any other pertinent\n" +
                "documents or agreed upon paperwork (specify) \n" +
